        ...
        >
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full border border-surface-border dark:border-stone-600 rounded-xl px-4 py-2.5 text-sm text-stone-800 dark:text-stone-100 dark:bg-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-900/20 dark:focus:ring-stone-500 focus:border-stone-400 dark:focus:border-stone-500"
            />
          </div>
